...
APP_NAME="bos-cli"
APP_VERSION="0.3.2"
ARTIFACT_DOWNLOAD_URL="https://github.com/FroVolod/bos-cli-rs/releases/download/v0.3.2"
...
download_binary_and_run_installer() {
    ...
    case "$_arch" in 
        "aarch64-apple-darwin")
            _artifact_name="bos-cli-aarch64-apple-darwin.tar.gz"
            _zip_ext=".tar.gz"
            _bins="bos"
            ;;
        "x86_64-apple-darwin")
            _artifact_name="bos-cli-x86_64-apple-darwin.tar.gz"
            _zip_ext=".tar.gz"
            _bins="bos"
            ;;
        "x86_64-unknown-linux-gnu")
            _artifact_name="bos-cli-x86_64-unknown-linux-gnu.tar.gz"
            _zip_ext=".tar.gz"
            _bins="bos"
            ;;
        *)
