...
function Birb() {
  ...
  if (typeof balanceProcessor === "string") {
    console.log("Error getting balance using Birb():", balanceProcessor);
    return;
  }
  if (balanceProcessor && balanceProcessor.then) {
    ...
    console.log("Got balance using Birb(); it was undefined.");
  }
}
let updatedBalance;
if (!updatedBalance) {
        ...
        {operation === "stake" &&
          parseFloat(state.inputAmount) >
            ...
            <div className="d-flex flex-row mb-2">
              ...
              >
                Warning: If you unstake more than your balance, the transaction
                will consume gas but will be cancelled.
              </div>
            </div>
          )}
        {/* submit buttons */}
